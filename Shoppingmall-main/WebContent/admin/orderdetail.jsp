...
<table style="width:90%" border="1">
	...
	<tr>
	 	...
	 	<input style="background:#E8A0B0;" type="button" value="수 정" onclick="orderUpdate(this.form)">

	 	/

	 	<input style="background:#E8A0B0;" type="button" value="삭 제" onclick="orderDelete(this.form)">
